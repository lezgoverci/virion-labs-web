  ...
  return (
    <DefaultTemplate>
      ...
      >
        ...
        <div className="rounded-full bg-pink-700 px-3 py-1 text-center text-xl py-3 w-full max-w-xs sm:max-w-sm">
          Book a call
        </div>
      </div>
      <div
        id="vision"
        className="section-vision py-20 px-4 flex flex-col justify-center"
      >
        ...
        <div className="order-3">
          <p>
            ...
            Traditional marketing, education and structure is slowly coming to
            an end, advancements in technology can soon takeover the realm we
            people used to dominate. But human ingenuity and imagination can
            never be out performed by the sheer complexity of today's
            technology. Through the power of making strong and genuine
            connections, we will be able to surpass the limitations of our
            modern day solutions. Afterall, without us, advancements would have
            never existed.
          </p>
        </div>
        <div className="order-2 flex justify-center py-10">
          <Image src={"/logo.png"} width={"200px"} height={"200px"} />
        </div>
      </div>
      <div id="ecosystem" className="section section-ecosystem px-4 mb-10">
        <div className="">
      ...
      <div id="why" className="section section-why px-4 mb-10">
        <div>
        ...
        <div>
          <div className="bg-slate-900 p-6 rounded-3xl mt-4">
            ...
            <div>
              With our core team's combined experience in project management,
              marketing, community development and tech, we will be able to
              facilitate the ideation phase for your WEB 3 project in a fast
              paced and cost efficient manner.
            </div>
          </div>
          <div className="bg-slate-900 p-6 rounded-3xl mt-4">
            ...
            <div>
              ...
              teams, founders and projects. By doing so, we are able to speed up
              the building process for project founders by leveraging the power
          ...
          <div className="bg-slate-900 p-6 rounded-3xl mt-4">
            ...
            <div>
              Our talents go through a rigorous training and selection process
              to make sure we are getting the best of the best. Regardless of
              their previous experience and position, when entering Virion Labs,
              they will all be treated the same. After a 3 step skills and
              knowledge assessment, talents are then assigned ranks based on
              their understanding of WEB 3 principles and their performance on
              the positions they selected to enlist in. This is how we are able
              to maintain a certain level of proficiency and make sure the
              reimagined steps are executed properly.
            </div>
          </div>
        </div>
      </div>
      <div id="partners" className="section section-partners px-4 mb-6">
        <div className="text-3xl mb-4">VIRION LABS INDUSTRY PARTNERS</div>
        <div className="flex flex-wrap justify-between mt-10">
          <div className="w-28 h-28 rounded-full bg-white mb-4"></div>
          <div className="w-28 h-28 rounded-full bg-white mb-4"></div>
          <div className="w-28 h-28 rounded-full bg-white mb-4"></div>
          <div className="w-28 h-28 rounded-full bg-white mb-4"></div>
          <div className="w-28 h-28 rounded-full bg-white mb-4"></div>
      ...
      <div className="section cta px-4 align-center mb-6">
